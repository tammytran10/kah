...
for isubj = 1:length(info.subj)
    ...
    input = load([info.path.processed.hd subject '/pac/ts/cf/' subject '_' experiment '_pac_between_ts_' num2str(timewin(1)) '_' num2str(timewin(2)) '_resamp.mat'], 'chanpairs', 'trialinfo', 'chans', 'temporal', 'frontal');
