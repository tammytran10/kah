...
for isubj = 1:length(info.subj)
    ...
    for iperm = 1:nperm
        ...
        input = load([info.path.processed.hd subject '_' experiment '_pac_between_-800_1600_resamp_' num2str(iperm) '.mat'], 'pacbetween');
    ...
    save([info.path.processed.hd subject '_' experiment '_pac_between_-800_1600_resamp_mean.mat'], 'pacbetween')
end
disp('Done')