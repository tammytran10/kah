...
for isubj = 7 % 1:length(info.subj)    
    ...
    % Copy trialshifts.
    copyfile([info.path.processed.hd subject '/pac/ts/' subject '_' experiment '_pac_between_ts_trialshifts_default.mat'], ...
        '/Volumes/voyteklab/tamtra/data/KAH/trialshifts/')
end
disp('Done.')
