...
info = kah_info;
subject    = 'R1032D'; % change this to read in different datasets;  which subjects have which sessions/experiments are described in .../protocols/r1.json
...
% detect line spectra
% param = struct;
% param.zthresh = 2; % default 2
% linespec = rmr_findlinespectra(data.trial{1}, data.fsample, [50,500], param);

linespec = struct;
linespec.peak = [60, 120, 180, 240, 300, 360, 420, 480];
linespec.halfbandw = repmat(0.25, size(linespec.peak));
