...
% 'R1154D' - 3    - 39T  - 20F   - 271/900   - 0.3011   - 28T  - 20F                          - ??? - Maybe too many line spectra. 
...
% 'R1166D' - 3    - 4T   - 39F   - 129/900   - 0.1433   - 4T   - 38F                          - ??? - Maybe too many line spectra. 
...
info.R1032D.FR1.bsfilt.peak      = [60, 63.8, 120.1, 180, 240.1 300];  % FR1 Session 1 (z-thresh 2)
info.R1032D.FR1.bsfilt.halfbandw = [0.5, 0.5, 0.5,   0.5, 0.5   0.5];   % FR1 Session 1 (z-thresh 2)
...
% Session 1/3 z-thresh 0.4
info.R1034D.FR1.bsfilt.peak = [60 61.1000 120 180 183.5000 240.1000 281.1000 296.3000 300 305.8000 ...
    172.3 212]; % manual
info.R1034D.FR1.bsfilt.halfbandw = [0.9000 0.5000 0.5000 0.8000 0.5000 0.7000 0.5000 0.5000 1.6000 0.5000 ...
    0.5 0.5];
...
% Session 1/1 z-thresh 0.5
info.R1020J.FR1.bsfilt.peak      = [60 120.1000 180 220.1000 240 300.1000];
info.R1020J.FR1.bsfilt.halfbandw =  [0.5000 0.5000 0.6000 0.5000 0.5000 0.7000];
